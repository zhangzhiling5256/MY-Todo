    ...
    return (
      <div>
        <ul className="detail_route">
          ...
          <div className="wraper1" ref="wraper1" style={{display: 'none'}}><img src={shop} alt="" className="img1"/>
          </div>
          ...
          <li onClick={this.handLi1}>
            {this.props.collectList.collState.collState ?
              <img src="https://static.home.mi.com/youpin/static/m/res/images/device_shop_detail_favor_v2.png" alt=""/>
              : <img src="https://static.home.mi.com/youpin/static/m/res/images/device_shop_detail_unfavor_v2.png"
                     alt=""/>
            }
